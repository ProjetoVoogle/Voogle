...
export const allCards: FeatureCardVideo[] = [
  {
    id: "seguroEletroeletronicos",
    text: "Seguro de Eletroeletrônicos",
    description: "Esta é a descrição do card 1.",
    image:
      "https://dicas.olx.com.br/wp-content/uploads/2024/05/ultimos-lancamentos-de-celular.jpg",
    category: "Recomendados",
    video: "https://videos.pexels.com/video-files/6558613/uhd_25fps.mp4",
  },
  {
    id: "seguroEmpresarial",
    text: "Seguro Empresarial",
    description: "Esta é a descrição do card 2.",
    image:
      "https://akadseguros.com.br/content/uploads/2023/06/seguro-empresarial-servicos-akad-1920x0-c-default.jpg",
    category: "Veículos",
    video:
      "https://videos.pexels.com/video-files/7149005/7149005-uhd_2560_1440_25fps.mp4",
  },
  {
    id: "seguroViagem",
    ...
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSmBP_FvJKm7U4P8YEU4EL6t37fE6lzadCM4Q&s",
    category: "Casa",
    video: "https://cdn.pixabay.com/video/2020/02/27/32945-395456395_large.mp4",
  },
  {
    id: "seguroGarantia",
    ...
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRWcLIJe9VkWzpbdzuzYritc5nIuHg-TgGK-A&s",
    category: "Financeiro",
    video:
      "https://videos.pexels.com/video-files/5519942/5519942-uhd_2560_1440_30fps.mp4",
  },
  {
    id: "seguroObra",
    text: "Seguro de obras e locações",
    description: "Esta é a descrição do card 5.",
    image:
      "https://blog.docket.com.br/wp-content/uploads/2021/09/AdobeStock_712794701Resultado-1089x730.webp",
    category: "Casa",
    video:
      "https://videos.pexels.com/video-files/14550172/14550172-uhd_2560_1440_30fps.mp4",
  },
  {
    id: "seguroFinanceiro",
    text: "Seguro Financeiro",
    description: "Esta é a descrição do card 6.",
    image:
      "https://revistaapolice.com.br/wp-content/uploads/elementor/thumbs/financas-qg11k0kq8p3btpo39fbdte8ob3mh5at8pdl6lqenpk.jpg",
    category: "Financeiro",
    video:
      "https://videos.pexels.com/video-files/3196002/3196002-uhd_2560_1440_25fps.mp4",
  },
  {
    id: "financiamentoConsorcio",
    text: "Financiamentos e Consórcios",
    description: "Esta é a descrição do card 7.",
    image:
      "https://revistaapolice.com.br/wp-content/uploads/elementor/thumbs/financas-qg11k0kq8p3btpo39fbdte8ob3mh5at8pdl6lqenpk.jpg",
    category: "Financeiro",
    video:
  ...
  },
  {
    id: "seguroVida",
    text: "Seguro de Vida",
    description: "Esta é a descrição do card 8.",
    image:
      "https://revistaapolice.com.br/wp-content/uploads/elementor/thumbs/financas-qg11k0kq8p3btpo39fbdte8ob3mh5at8pdl6lqenpk.jpg",
    category: "Financeiro",
    video:
  ...
  },
  {
    ...
    description: "Esta é a descrição do card 9.",
    image:
      "https://revistaapolice.com.br/wp-content/uploads/elementor/thumbs/financas-qg11k0kq8p3btpo39fbdte8ob3mh5at8pdl6lqenpk.jpg",
    category: "Financeiro",
    video:
  ...
  },
  {
    ...
    description: "Esta é a descrição do card 10.",
    image:
      "https://revistaapolice.com.br/wp-content/uploads/elementor/thumbs/financas-qg11k0kq8p3btpo39fbdte8ob3mh5at8pdl6lqenpk.jpg",
    category: "Financeiro",
    video:
...
const SeguroCarousel: React.FC = () => {
  ...
  const nextCards = () => {
    setCurrentIndex((prev) =>
      prev + 1 < filteredCards.length - visibleCards + 1 ? prev + 1 : prev
    );
  };
